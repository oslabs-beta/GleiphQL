...
const InstructionSection: React.FC<{}> = () => {
  ...
  <section className='p-8 text-center flex flex-col md:flex-row'>
    <div className='md:w-1/2'>
      ...
      <a href='https://github.com/oslabs-beta/graphql-rate-limiter' target='_blank' ><button className='rounded-md border text-white bg-blue-950 font-semibold p-2 m-4 w-32'>More Info</button></a>
    </div>
